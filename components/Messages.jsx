  ...
  return (
    <div className="messages">
     ...
     ( props.topQuestions.length ==0 ? null: 
       ...
       <Button className="trending-button1">{props.topQuestions[0]}</Button>
       <Button className="trending-button1">{props.topQuestions[1]}</Button>
       <Button className="trending-button1">{props.topQuestions[2]}</Button>
       <Button className="trending-button1">{props.topQuestions[3]}</Button>
       <Button className="trending-button1">{props.topQuestions[4]}</Button>
       </div> )
