...
const Chat = () => {
  ...
  return (
    <div className="chat">
      ...
      {(docUpload)?<Messages topQuestions={topQuestions} chatResponseMode={selectedValue}/>:
      ...
      <Input update={(e)=>{setTopQuestions(e)}}  selectButton={()=>updateSelection()} chatResponseMode={selectedValue} docUpload={docUpload} mode={mode} file={doc} sendDoc={()=>SetDocUpload(true)}/>
    </div>
  );
};
